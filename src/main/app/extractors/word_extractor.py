...
class WordExtractor:
    ...
    def get_word_iter(self, data: tuple[int], to_lower: bool = True) -> Iterator[Word]:
        """
        Возвращает итератор по всем словам в data

        :param to_lower: перевод в нижний регистр (по умолчанию True)
        :param data: последовательность символов в виде их номеров
